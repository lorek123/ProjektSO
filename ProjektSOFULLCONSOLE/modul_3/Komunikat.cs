...
namespace ProjektSOFULL.modul_3
{
    public class Komunikat
    {
        ...
        public Komunikat Czytaj_Komunikat(string odbiorca)
        {
            ...
            Console.WriteLine("MESSAGE_SEMAPHORE_RECEIVER: " + modul_1.receiver.modul_1.semafor.value);
            receiver.modul_1.message_semaphore_common--;
            Console.WriteLine("MESSAGE_SEMAPHORE_COMMON: " +modul_1.receiver.modul_1.message_semaphore_common);
            Komunikat odebrany;
            ...
            Console.WriteLine("Odebrano komunikat od procesu " + nadawca);
            Console.WriteLine("Treść: " + tekst);
            receiver.modul_1.message_semaphore_common++;
            return odebrany;
}
        ...
        public void Wysylaj_Komunikat(string odbiorca, string tekst)
        {
            ...
            {
                Console.WriteLine("MESSAGE_SEMAPHORE_COMMON: " + receiver.message_semaphore_common);
                ...
                Console.WriteLine("MESSAGE_SEMAPHORE_RECEIVER: " + receiver.semafor.value);
            }
            receiver.message_semaphore_common++;
            Console.WriteLine("Wysłano komunikat do procesu " + odbiorca);
            Console.WriteLine("Treść: " + tekst);
